...
public class MediumOakLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:medium_oak_log")
	public static final Block block = null;

	public MediumOakLogBlock(StumpModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("medium_oak_log");
		}
