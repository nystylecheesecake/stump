...
public class SmallJungleLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:small_jungle_log")
	public static final Block block = null;

	public SmallJungleLogBlock(StumpModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("small_jungle_log");
		}
