...
public class MediumSpruceLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:medium_spruce_log")
	public static final Block block = null;

	public MediumSpruceLogBlock(StumpModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("medium_spruce_log");
		}
