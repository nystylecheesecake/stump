...
public class SmallDarkOakLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:small_dark_oak_log")
	public static final Block block = null;

	public SmallDarkOakLogBlock(StumpModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("small_dark_oak_log");
		}
