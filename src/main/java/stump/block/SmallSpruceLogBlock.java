...
public class SmallSpruceLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:small_spruce_log")
	public static final Block block = null;

	public SmallSpruceLogBlock(StumpModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("small_spruce_log");
		}
