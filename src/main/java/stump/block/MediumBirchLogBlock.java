...
public class MediumBirchLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:medium_birch_log")
	public static final Block block = null;

	public MediumBirchLogBlock(StumpModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("medium_birch_log");
		}
