...
public class SmallAcaciaLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:small_acacia_log")
	public static final Block block = null;

	public SmallAcaciaLogBlock(StumpModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("small_acacia_log");
		}
