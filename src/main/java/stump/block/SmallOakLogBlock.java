...
public class SmallOakLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:small_oak_log")
	public static final Block block = null;

	public SmallOakLogBlock(StumpModElements instance) {
		super(instance, 1);
	}
