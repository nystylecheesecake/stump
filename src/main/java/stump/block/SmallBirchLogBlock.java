...
public class SmallBirchLogBlock extends StumpModElements.ModElement {
	@ObjectHolder("stump:small_birch_log")
	public static final Block block = null;

	public SmallBirchLogBlock(StumpModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("small_birch_log");
		}
